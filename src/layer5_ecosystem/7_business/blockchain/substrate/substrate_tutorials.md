...
<!-- Added by: runner, at: Tue Jul 26 07:54:17 UTC 2022 -->
...
```plantuml
{{#include ../../../../../materials/plantumls/substrate_tutorials/connect-with-other-chains/connect-to-rococo-testnet.puml:1:k}}
```
